...
public class NeighbourhoodManager {
    ...
    public static void delete(JSONObject payload, String agentId, String agentPassword) throws Exception {
        ...
        ClientResponse deleteResponse = GatewayAPIClient.post(GatewayAPIClient.deleteEndpoint(agentId), payload.toString(), agentId, agentPassword, null);
    ...
    public static String create(JSONObject payload, AgentConfig agent) throws Exception {
        ...
        ClientResponse createResponse = GatewayAPIClient.post(GatewayAPIClient.createEndpoint(agent.agentId), payload.toString(), agent.agentId, agent.password, null);
...
//        logger.info("test response: \n" + test);
    ...
    public static String update(JSONObject payload, AgentConfig agent) throws Exception {
        ...
        ClientResponse updateResponse = GatewayAPIClient.put(GatewayAPIClient.updateEndpoint(agent.agentId), payload.toString(), agent.agentId, agent.password, null);
    ...
    public static String updateContent(JSONObject payload, AgentConfig agent) throws Exception {
        ...
        ClientResponse updateResponse = GatewayAPIClient.put(GatewayAPIClient.updateContentEndpoint(agent.agentId), payload.toString(), agent.agentId, agent.password, null);
