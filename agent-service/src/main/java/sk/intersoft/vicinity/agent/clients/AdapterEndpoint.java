...
public class AdapterEndpoint {
    ...
    public static String getReceiveEventEndpoint(String infrastructureId, String publisherId, String eventId)  {
        return "/objects/"+infrastructureId+"/publishers/"+publisherId+"/events/"+eventId;
    }
