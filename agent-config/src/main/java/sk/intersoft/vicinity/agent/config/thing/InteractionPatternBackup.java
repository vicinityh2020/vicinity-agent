...
public class InteractionPatternBackup {
    ...
    public InteractionPatternBackup(String id, String readEndpoint, String writeEndpoint) {
        this.id = id;
    ...
    public static InteractionPatternBackup create(JSONObject object, String idKey) throws Exception {
        ...
        if(reads != null || writes != null){
            ...
            return new InteractionPatternBackup(id, readHref, writeHref);
        }
        else if(links != null){
            String href = getHref(links);
            return new InteractionPatternBackup(id, href, href);
        }
        else {
